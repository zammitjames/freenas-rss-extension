				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td valign="middle" nowrap class="list">
							<a href="rss_feed_edit.php?id=<?=$i;?>"><img src="e.gif" title="<?=gettext("Edit feed");?>" border="0"></a>&nbsp;
							<a href="rss_feed_manage.php?act=del&id=<?=$i;?>" onclick="return confirm('<?=gettext("Do you really want to delete this feed?"); ?>')"><img src="x.gif" title="<?=gettext("Delete feed"); ?>" border="0"></a>
						</td>
					</tr>
					<?php $i++; endforeach;?>
					<tr>
						<td class="list" colspan="6"></td>
						<td class="list"> <a href="rss_feed_edit.php"><img src="plus.gif" title="<?=gettext("Add feed"); ?>" border="0"></a></td>
					</tr>
				</table>
			</form>
        </td>
